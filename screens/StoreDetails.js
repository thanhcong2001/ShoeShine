...
const StoreDetails = ({ route }) => {
  ...
  const fetchDataFromApi = async () => {
    try {
      const response = await axios.get(
        `http://shoeshine-001-site1.ftempurl.com/api/categories/${Id}`
      );
  ...
  const renderTypeItem = ({ item }) => (
    <TouchableOpacity
      style={[
        styles.Circle,
        {
          backgroundColor: selectedOptions.includes(item.categoryId)
            ? "#40BFFF"
            : "white",
        },
      ]}
    ...
    >
      <Text style={{ fontWeight: "bold", color: "#223263" }}>
        {item.categoryName}
      </Text>
    </TouchableOpacity>
  );
  ...
  const fetchService = async () => {
    try {
      const response = await axios.get(
        `http://shoeshine-001-site1.ftempurl.com/api/services/${Id}`
      );
  ...
  const renderServiceItem = ({ item }) => (
    <TouchableOpacity
      style={[
        ...
        {
          backgroundColor:
            selectedService === item.serviceId ? "#40BFFF" : "white",
        },
      ]}
  ...
  const ImageOfFeedBack = [
    {
      id: "1",
      imageUrl:
        "https://i.pinimg.com/564x/9c/9f/b6/9c9fb6561174109d521064d2efb4d6cb.jpg",
    },
    {
      id: "2",
      imageUrl:
        "https://i.pinimg.com/564x/4e/f3/a1/4ef3a14ef067abdee38b5436f46f38a8.jpg",
    },
    {
      id: "3",
      imageUrl:
        "https://i.pinimg.com/564x/d0/fe/53/d0fe531d75a9472c4a630afce2f032e4.jpg",
    },
    {
      id: "4",
      imageUrl:
        "https://www.iuoss.com/wp-content/uploads/2017/09/1-1024x683.jpg",
    },
    {
      id: "5",
      imageUrl:
  ...
  const storeNear = [
    ...
    },
    {
      ...
      distance: "4km",
      location: "District 3",
      image: require("../assets/BBCleaning.jpg"),
    },
    {
      id: "3",
      name: "Store DR.Thong",
      ...
      image: require("../assets/DrThong.jpg"),
    },
    {
      id: "4",
      name: "Sneaker Vitamin",
      distance: "7km",
      location: "District 8",
    ...
    },
    {
      ...
      distance: "10km",
      location: "District 1",
      image: require("../assets/xClean.jpg"),
    },
    {
      id: "7",
      name: "Store DR.Thong",
  ...
  const renderStoreItem = ({ item }) => (
    ...
    >
      ...
      <Image
        style={{ width: wp("20%"), height: hp("1.8%") }}
        source={rating1}
      />
  ...
  const onBooking = async () => {
    ...
    console.log("dataToSend Book", dataToSend);
    await addData(dataToSend);
    navigation.navigate("Shipping", { dataToSend: dataToSend });
  ...
  return (
    <View style={styles.All}>
      <ScrollView>
        ...
        <View>
          <Image
            style={{ marginLeft: wp("6%"), width: wp("30%"), height: hp("5%") }}
            source={rating1}
          />
        </View>
        <View>
        ...
        <View>
          ...
          >
            Separate process for each shoe material, Dedicated, experienced
            staff, Imported solution, safe for shoes, Track progress, order
        ...
        <View>
          <Text style={{ marginLeft: wp("6%"), paddingRight: wp("1%") }}>
