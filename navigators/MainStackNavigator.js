  ...
  return (
    <Tab.Navigator>
      <Tab.Screen
        name="Home"
        component={Home}
        options={{ tabBarIcon: ({ color }) => <Icon name="home" size={wp("7%")} color={color} />, headerShown: false }}
      />
      <Tab.Screen
        name="Explore"
        component={Explore}
        options={{
          tabBarIcon: ({ color }) => <Icon name="search" size={wp("7%")} color={color} />,
          headerShown: false,
        }}
      />
      <Tab.Screen
...
const MainStackNavigator = () => {
  return (
    <Stack.Navigator>
      ...
      {/* store */}
      <Stack.Screen name="Store" component={Store} options={{ title: "Shop của tôi" }} />
    </Stack.Navigator>
  );
};
